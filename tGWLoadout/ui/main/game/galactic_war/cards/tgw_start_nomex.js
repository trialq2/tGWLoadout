define([
    ...
    return {
        ...
        describe: function (params) { return 'In this loadout, the commander has lost the blueprints for building metal extractors. Luckily the metal generation sub-systems remained active during hibernation, slowly stockpiling metal over the centuries.'; },
